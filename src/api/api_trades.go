...
func (r ApiListTradesRequest) PartyATokenId(partyATokenId string) ApiListTradesRequest {
	r.partyATokenId = &partyATokenId
	return r
}
...
func (a *TradesApiService) ListTradesExecute(r ApiListTradesRequest) (*ListTradesResponse, *http.Response, error) {
	...
	if r.partyATokenId != nil {
		localVarQueryParams.Add("party_a_token_id", parameterToString(*r.partyATokenId, ""))
	}
