...
type GetTransferOK struct {
	Payload *models.Transfer
}

func (o *GetTransferOK) Error() string {
	return fmt.Sprintf("[GET /v1/transfers/{id}][%d] getTransferOK  %+v", 200, o.Payload)
}
func (o *GetTransferOK) GetPayload() *models.Transfer {
	return o.Payload
}
