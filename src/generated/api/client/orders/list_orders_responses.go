...
type ListOrdersOK struct {
	Payload *models.ListOrdersResponse
}

func (o *ListOrdersOK) Error() string {
	return fmt.Sprintf("[GET /v1/orders][%d] listOrdersOK  %+v", 200, o.Payload)
}
func (o *ListOrdersOK) GetPayload() *models.ListOrdersResponse {
	return o.Payload
}

func (o *ListOrdersOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.ListOrdersResponse)
