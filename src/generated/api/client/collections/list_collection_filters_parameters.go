...
// AddCustomHeader provides option to add custom header parameters to list collection filters params.
func (o *ListCollectionFiltersParams) AddCustomHeader(key string, value string) {
