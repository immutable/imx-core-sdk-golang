...
type GetTokenOK struct {
	Payload *models.TokenDetails
}

func (o *GetTokenOK) Error() string {
	return fmt.Sprintf("[GET /v1/tokens/{address}][%d] getTokenOK  %+v", 200, o.Payload)
}
func (o *GetTokenOK) GetPayload() *models.TokenDetails {
	return o.Payload
}

func (o *GetTokenOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.TokenDetails)
