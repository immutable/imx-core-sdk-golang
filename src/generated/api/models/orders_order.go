...
// Validate validates this orders order
func (m *OrdersOrder) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *OrdersOrder) validateAmountSold(formats strfmt.Registry) error {
...
func (m *OrdersOrder) validateBuy(formats strfmt.Registry) error {
...
func (m *OrdersOrder) validateExpirationTimestamp(formats strfmt.Registry) error {
...
func (m *OrdersOrder) validateFees(formats strfmt.Registry) error {
...
func (m *OrdersOrder) validateOrderID(formats strfmt.Registry) error {
...
func (m *OrdersOrder) validateSell(formats strfmt.Registry) error {
...
func (m *OrdersOrder) validateStatus(formats strfmt.Registry) error {
...
func (m *OrdersOrder) validateTimestamp(formats strfmt.Registry) error {
...
func (m *OrdersOrder) validateUpdatedTimestamp(formats strfmt.Registry) error {
...
func (m *OrdersOrder) validateUser(formats strfmt.Registry) error {
...
// ContextValidate validate this orders order based on the context it is used
func (m *OrdersOrder) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *OrdersOrder) contextValidateBuy(ctx context.Context, formats strfmt.Registry) error {
...
func (m *OrdersOrder) contextValidateFees(ctx context.Context, formats strfmt.Registry) error {
...
func (m *OrdersOrder) contextValidateSell(ctx context.Context, formats strfmt.Registry) error {
...
func (m *OrdersOrder) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *OrdersOrder) UnmarshalBinary(b []byte) error {
	var res OrdersOrder
