...
import (
	...
	internalSigners "github.com/immutable/imx-core-sdk-golang/signers/internal/signers"
)
...
func CreateOrder(ctx context.Context,
	...
	ethSignature, starkSignature, err := internalSigners.CreateSignatures(&signableOrder.SignableMessage, &signableOrder.PayloadHash, l1signer, l2signer)
	if err != nil {
		return nil, err
	}
...
func CancelOrder(ctx context.Context,
	...
	ethSignature, starkSignature, err := internalSigners.CreateSignatures(&signableCancelOrder.SignableMessage, &signableCancelOrder.PayloadHash, l1signer, l2signer)
	if err != nil {
		return nil, err
	}
