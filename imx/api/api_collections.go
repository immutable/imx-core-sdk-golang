...
func (a *CollectionsApiService) ListCollectionFiltersExecute(r ApiListCollectionFiltersRequest) (*CollectionFilter, *http.Response, error) {
	...
	if r.nextPageToken != nil {
		parameterAddToQuery(localVarQueryParams, "next_page_token", r.nextPageToken, "")
	}
	// to determine the Content-Type header
	localVarHTTPContentTypes := []string{}
...
func (a *CollectionsApiService) ListCollectionsExecute(r ApiListCollectionsRequest) (*ListCollectionsResponse, *http.Response, error) {
	...
	if r.blacklist != nil {
		parameterAddToQuery(localVarQueryParams, "blacklist", r.blacklist, "")
	}
	if r.whitelist != nil {
		parameterAddToQuery(localVarQueryParams, "whitelist", r.whitelist, "")
	}
	if r.keyword != nil {
		parameterAddToQuery(localVarQueryParams, "keyword", r.keyword, "")
	}
	// to determine the Content-Type header
	localVarHTTPContentTypes := []string{}
