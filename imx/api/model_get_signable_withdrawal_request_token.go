...
// GetSignableWithdrawalRequestToken Token to withdraw
type GetSignableWithdrawalRequestToken struct {
...
func NewGetSignableWithdrawalRequestToken() *GetSignableWithdrawalRequestToken {
	this := GetSignableWithdrawalRequestToken{}
	return &this
}
...
func (o GetSignableWithdrawalRequestToken) MarshalJSON() ([]byte, error) {
...
type NullableGetSignableWithdrawalRequestToken struct {
	value *GetSignableWithdrawalRequestToken
	isSet bool
}

func (v NullableGetSignableWithdrawalRequestToken) Get() *GetSignableWithdrawalRequestToken {
	return v.value
}

func (v *NullableGetSignableWithdrawalRequestToken) Set(val *GetSignableWithdrawalRequestToken) {
	v.value = val
	v.isSet = true
}

func (v NullableGetSignableWithdrawalRequestToken) IsSet() bool {
	return v.isSet
}

func (v *NullableGetSignableWithdrawalRequestToken) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetSignableWithdrawalRequestToken(val *GetSignableWithdrawalRequestToken) *NullableGetSignableWithdrawalRequestToken {
	return &NullableGetSignableWithdrawalRequestToken{value: val, isSet: true}
}

func (v NullableGetSignableWithdrawalRequestToken) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetSignableWithdrawalRequestToken) UnmarshalJSON(src []byte) error {
	v.isSet = true
