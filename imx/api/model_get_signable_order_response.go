...
// checks if the GetSignableOrderResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetSignableOrderResponse{}
...
func (o GetSignableOrderResponse) ToMap() (map[string]interface{}, error) {
