...
**FromAmount** | Pointer to **float32** | Amount of currency (from_currency) used for transaction | [optional] 
**FromCurrency** | Pointer to **string** | Currency used for transaction | [optional] 
**MintId** | Pointer to **string** | Mint id | [optional] 
...
**ToAmount** | Pointer to **float32** | Amount of target currency (to_currency) bought | [optional] 
**ToCurrency** | Pointer to **string** | Target currency | [optional] 
