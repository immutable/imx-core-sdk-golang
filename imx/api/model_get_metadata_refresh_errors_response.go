...
// checks if the GetMetadataRefreshErrorsResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetMetadataRefreshErrorsResponse{}
...
func (o GetMetadataRefreshErrorsResponse) ToMap() (map[string]interface{}, error) {
