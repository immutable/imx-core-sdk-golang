...
// checks if the ListMintsResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListMintsResponse{}
...
func (o ListMintsResponse) ToMap() (map[string]interface{}, error) {
