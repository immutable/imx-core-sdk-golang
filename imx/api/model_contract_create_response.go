...
// checks if the ContractCreateResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ContractCreateResponse{}
...
func (o ContractCreateResponse) ToMap() (map[string]interface{}, error) {
