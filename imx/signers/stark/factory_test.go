...
func TestStarkSignerFactory_GenerateLegacyKey_GrindkeyFix(t *testing.T) {
	...
	tests := []test{
		...
		},
		{
			...
			wantPublicKey: "0x3c35bb183cc613d57e6c823a6c7a17a14fba9dc65a5ece97a87020e32cbbd9", // Compatible with grindKeyLegacy, With Expected Index of 0,0,0,... // Hash Iterated 0 times
		},
		{
			...
			wantPublicKey: "0x0743a17b8a566fe39cfebc41db631210bf328b91ae6c3968f1f9a96ac48a02aa", // Compatible with grindKeyLegacy, With Expected Index of 0,0,0,... // Hash Iterated 1 time
		},
		{
			...
			wantPublicKey: "0x07d14076863573a2310a948472512331416ceb655a304b1811a127e6c710e350", // Compatible with grindKeyLegacy, With Expected Index of 0,0,0,... // Hash Iterated 2 times
		},
		{
			...
			wantPublicKey: "0x07ca61905954bdd858ae63704b111da5ca52b30a21fa9aaeee9aef9b24e89607", // Compatible with grindKey, with Expected Index of 0,1,2,... // Hash Iterated 1 time
		},
		{
			...
			wantPublicKey: "0x0157c6efcb2c69604c1b46ffeb568b3b10ea7093da762e1daf66b59d9b63b5f9", // Compatible with grindKey, with Expected Index of 0,1,2,... // Hash Iterated 2 times
		},
		{
		...
		},
		{
			...
			wantPublicKey: "0x03aa9edf4a5b33f623d3dd37a6df62e5590f172fd4d1a9483532464aa13bcbb9", // Compatible with grindKeyV100Beta1, with Expected Index of 0,0,1,... // Hash Iterated 1 time
		},
		{
			...
			wantPublicKey: "0x057a8278637277ebaaa63b000185507eb847eec8f69c7758fc10a490d0226e7d", // Compatible with core-sdk GrindKey, with Expected Index of 0,0,1,... // Hash Iterated 2 times
		},
		{
			...
			wantPublicKey: "0x05f8f00b03e896cb8c02a936bab73623fc3651fddabfe0d28fbc309c63642c10", // Hash Iterated 1 time
		},
		{
			...
			wantPublicKey: "0x04d34c9f519b2a3538b02c4e939188b591065eb8c2f210277c6ed1de85b16fab", // Hash Iterated 2 times
		},
		{
			...
			wantPublicKey: "0x06e6ac4bb44f3295b881532452f90eccb5601314fafe306db17684b47aa388bd", // Hash Iterated 0 times
		},
	}
	for _, tt := range tests {
